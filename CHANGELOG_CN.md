...
## v10.34.0 (2026-04-24)（最新版本）

本版本强化 AI 配置管理（拖拽排序与从现有配置复制创建），系统打磨主题与用户消息气泡层次，并修复 DeepSeek 思考模式下的工具调用与蓝色主题对比度等问题。
...
### 问题修复
- 🐛 **DeepSeek 思考模式工具调用**：适配 V3.2+/V4 思考模式下工具调用需回传 `reasoning_content` 的要求
