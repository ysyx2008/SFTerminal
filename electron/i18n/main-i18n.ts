...
const translations = {
  'zh-CN': {
    ...
    'dialog.restoreConfirmDetail': '当前全部数据将被替换，应用随后重启。此操作不可撤销。',
  ...
  'en-US': {
    ...
    'dialog.restoreConfirmDetail': 'All current data will be replaced and the app will restart. This cannot be undone.',
