...
const electronAPI = {
  ...
  agent: {
    ...
    addMessage: (ptyId: string, message: string, attachments?: import('@shared/types').AttachmentInfo[], documentContext?: string, images?: string[]) =>
      ipcRenderer.invoke('agent:addMessage', ptyId, message, attachments, documentContext, images) as Promise<boolean>,
