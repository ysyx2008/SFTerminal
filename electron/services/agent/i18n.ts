...
[系统/任务的当前状态]`,
    ...
    'file.protected_workspace_path': '受保护的个性配置文件，禁止通过文件工具修改：{path}（请使用 personality_craft / soul_craft 或设置页）',
...
[Current state of system/tasks]`,
    ...
    'file.protected_workspace_path': 'Protected personality config file, cannot modify via file tools: {path} (use personality_craft / soul_craft or Settings)',
