...
[系统/任务的当前状态]`,
    ...
    'ppt.appended_from_html': '已追加 {added} 页，演示文稿现 {slides} 页: {path}；预览 HTML: {htmlPath}',
    ...
    'ppt.created_from_html': '已生成演示文稿: {path}（{slides} 页）；预览 HTML: {htmlPath}',
    // 样式管理
...
[Current state of system/tasks]`,
    ...
    'ppt.appended_from_html': 'Appended {added} slides, now {slides} total: {path}; preview HTML: {htmlPath}',
    ...
    'ppt.created_from_html': 'Presentation saved: {path} ({slides} slides); preview HTML: {htmlPath}',
    // Style management
