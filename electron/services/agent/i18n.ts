...
- 多维表格筛选使用 JSON 格式 filter 参数`,
    ...
    'exec.awaiting': '等待后台任务 {taskId}：{command}',
    'exec.awaiting_short': '等待',
    'exec.awaiting_pattern': '等待 {taskId} 命中「{pattern}」：{command}',
...
- Bitable filter uses JSON format with conditions`,
    ...
    'exec.awaiting': 'Awaiting background task {taskId}: {command}',
    'exec.awaiting_short': 'Awaiting',
    'exec.awaiting_pattern': 'Awaiting {taskId} for “{pattern}”: {command}',
    'exec.task_done': '[task_id={taskId}, status={status}, exit_code={exitCode}]',
