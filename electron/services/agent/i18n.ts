...
- 多维表格筛选使用 JSON 格式 filter 参数`,
    ...
    'risk.reason.workspace_free': '目标位于工作区自由区（scratch/charts），允许自动执行',
    'risk.reason.workspace_outside': '目标位于工作区外，需确认',
...
- Bitable filter uses JSON format with conditions`,
    ...
    'risk.reason.workspace_free': 'Target is in workspace free zone (scratch/charts), auto-approved',
    'risk.reason.workspace_outside': 'Target is outside the workspace, requires confirmation',
