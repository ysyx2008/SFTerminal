...
- 多维表格筛选使用 JSON 格式 filter 参数`,
    ...
    'error.api_model_not_found': '模型 {model} 不存在或未开通，请检查模型名称或在控制台开通该模型后再试。',
...
- Bitable filter uses JSON format with conditions`,
    ...
    'error.api_model_not_found': 'Model {model} does not exist or is not enabled. Please verify the model name or enable it in the provider dashboard.',
