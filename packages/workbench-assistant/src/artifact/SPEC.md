...
**产出物清单（2026-08-17 确认）**：有产出物时，清单按钮钉在对话区右上角（产出物面板开着时停在分隔线旁，不跟工作台最右侧的折叠开关绑在一起）；没有产出物时按钮消失。点开是一块实底小面板，宽度随名称长短伸缩，进出带一点弹性；点某一项就打开产出物面板并显示该项。不靠鼠标贴边自动弹出。
...
- **清单**：有产出物才出现；按钮钉在对话区右上。点开是实底小面板，宽度随名称伸缩，点选即打开并显示该项
