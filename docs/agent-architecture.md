...
本文档以旗鱼（SailFish）的 Agent 实现为例，详细介绍 AI Agent 的工作原理，包括 ReAct 机制、工具调用、任务规划等核心概念。
...
在旗鱼中，Agent 可以帮助用户执行服务器运维任务，如执行命令、读写文件、诊断问题等。
...
旗鱼的 Agent 实现展示了一个完整的 AI Agent 系统应该具备的核心能力：
