...
> Last verified: 2026-09-04（文档铺满时对话退成一句）
...
> **文档铺满时对话退成一句（2026-08-25）**
>
> - **问题**：人在盯着文件看时，整栏对话是占地方的背景音。
> - **成功标准**：铺满时对话流藏起，输入留下；文档上浮它刚说的那句或它在忙什么。要你动手的确认、提问、密码完整出现，不能收成一句。点那句话只展开或收起，不把人冲回分栏。
> - **关键取舍**：不另写摘要，沿用过程折叠的口径。
