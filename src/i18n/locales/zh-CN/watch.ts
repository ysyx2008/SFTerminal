...
export default {
  ...
  watch: {
    ...
    overviewListeningOnly: '{n} 个关切在事件监听中（无定时计划）',
    overviewGoTemplates: '从模板创建',
    overviewViewAllHistory: '查看全部',
    overviewBack: '返回',
    overviewViewMore: '更多',
    overviewClearFocus: '返回',
    overviewRecentForWatch: '{name} · 最近流水',
    overviewNoHistoryForWatch: '该关切尚无执行记录',
    overviewHistoryForWatch: '{name} · 运行历史',
    overviewShowAllWatchesHistory: '全部关切',
    sectionAnomalies: '异常关切',
    retryWatch: '立即重试',
    disableWatch: '停用此关切',
    viewFailure: '查看失败详情',
    cancelRunning: '取消执行',
    liveOutputHint: '点击查看内心独白',
    sectionRunning: '正在执行',
