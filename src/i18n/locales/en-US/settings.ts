  ...
  settings: {
    ...
    security: {
      ...
      userAllowlist: {
        ...
        description: 'Commands you approved with "Always Allow" are stored here globally across restarts. The Agent cannot modify this list.',
        empty: 'No entries',
        emptyHint: 'When you choose "Always Allow" in the Agent confirmation dialog, the entry will appear here.',
