...
export default {
  ...
  browserBridge: {
    ...
    statusConnected: '{count} extension(s) connected',
    statusDisconnected: 'Not connected',
    wizardStep1Short: 'Install SailFish components',
    wizardStep2Short: 'Load extension in browser',
    wizardHint: 'Two steps. Step 1 is automatic. Step 2 requires manually loading the extension once (browser security, ~1 min).',
    step1Title: 'Step 1: Install SailFish components',
    step1Desc: 'Copy extension files locally and register the native messaging host.',
    step1Done: 'Components ready. Continue to step 2.',
    step2Title: 'Step 2: Load extension in your browser',
    step2Desc: 'On Mac, no copy/paste needed — drag the folder from Finder into Chrome.',
    step2Locked: 'Complete step 1 first',
    extensionPathLabel: 'Extension folder path',
    copyPath: 'Copy path',
    copied: 'Copied',
    copyFailed: 'Copy failed — select the path manually',
    pasteHintWin: 'When Chrome shows the folder picker: paste the path in the address bar → Enter → Select.',
    startLoadChromeMac: 'Open Chrome extensions',
    startLoadChrome: 'Copy path & open Chrome extensions',
    startLoadEdge: 'Use Edge instead',
    startLoadFirefox: 'Open Firefox debugging',
    startLoadFirefoxMac: 'Open Firefox debugging',
    ...
    firefoxDragMethodTitle: 'Easiest: drag manifest.json (no paste)',
    ...
    firefoxDragFolderHint: 'inside the {folder} folder',
    firefoxPasteMethodTitle: 'Alternative: pick the file manually',
    firefoxPasteMethodNote: 'In Firefox\'s file picker, go to the path below and select manifest.json (not the folder).',
    firefoxPasteHintWin: 'Firefox debugging is open. Click Load Temporary Add-on, paste the path below, select manifest.json.',
    firefoxStep3Mac: 'Drag manifest.json from Finder into Firefox\'s file picker (see green box above)',
    ...
    dragMethodTitle: 'Easiest: drag the folder (no paste, no address bar)',
    ...
    pasteMethodTitle: 'Alternative: paste path (advanced)',
    pasteMethodNote: 'Not in Finder — Finder has no address bar. Press ⌘⇧G inside Chrome\'s "Select extension directory" dialog to get a path field.',
    pasteMethodStep1: 'When Chrome\'s picker appears, press ⌘⇧G (Go to Folder)',
    pasteMethodStep2: 'Paste the path below → Enter → Select',
    chromeStepsTag: 'Detailed steps',
    chromeStep1: 'Click "Open Chrome extensions" above',
    chromeStep2: 'Enable Developer mode, then Load unpacked',
    chromeStep3Mac: 'Drag the {folder} folder from Finder into Chrome\'s picker (see green box above)',
    chromeStep3Win: 'Paste path in the picker address bar, Enter, Select',
    edgeStepsTag: 'Same as Chrome',
    edgeStep1: 'Click "Use Edge instead", enable Developer mode on edge://extensions',
    edgeStep2Mac: 'Load unpacked, drag the {folder} folder into the picker',
    edgeStep2Win: 'Load unpacked, paste path in address bar',
    firefoxStep1: 'Click the button in the Firefox section above',
    ...
    recheckHint: 'If still not connected after loading the extension, ',
    recheck: 'recheck connection',
    rechecking: 'Checking…',
    install: 'Install components',
    installing: 'Installing…',
    installSuccess: 'Step 1 done. Expand a browser below and load the extension.',
    ...
    howToLoadFirefox: 'How to load the extension?',
    advancedTitle: 'Advanced',
    setupTitle: 'Load Browser Extension',
    setupDesc: 'After installing components, pick your browser and follow the steps.',
    chromiumShared: 'Chromium extension',
    chromeTitle: 'Google Chrome',
    edgeTitle: 'Microsoft Edge',
    firefoxTitle: 'Mozilla Firefox',
    firefoxTempTag: 'Temporary',
    ...
    openChromiumFolder: 'Open Chromium extension folder',
    openFirefoxFolder: 'Open Firefox extension folder',
    ...
    troubleshootStep1: 'Click Reinstall in step 1, then fully quit Chrome (⌘Q) and reopen',
    ...
    troubleshootStep3: 'Keep SailFish running, then click recheck on this page',
    ...
    agentTitle: 'Agent usage',
    agentDesc: 'After step 2 shows Connected, the Agent can use attach mode:',
    agentDescReady: 'Connected. The Agent can use attach mode:',
    connected: '{count} extension(s) connected',
    notConnected: 'Not connected',
    refresh: 'Refresh status',
    loadExtensionTitle: 'Load extension (one-time)',
    stepInstall: 'Click install above',
    stepChrome: 'Chrome: extensions → Developer mode → Load unpacked',
    stepEdge: 'Edge: same on edge://extensions',
    stepFirefox: 'Firefox: about:debugging → Load Temporary Add-on',
    agentHint: 'Agent uses browser_launch { "attach": true }.',
  },
}
