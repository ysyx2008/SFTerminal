  ...
  settings: {
    ...
    security: {
      ...
      builtinRules: {
        ...
        colCmd: 'Command',
        colBaseLevel: 'Base Level',
        colSafeFlags: 'Allowed options',
        colPathMode: 'Path Mode',
        colWritesTo: 'Modifies files',
        pathModeAll: 'All path args',
        pathModeFixed: 'Fixed-position paths',
        pathModeNone: 'No path',
        writesYes: 'Yes',
        writesNo: 'No',
        ...
        workspaceZonesDesc: 'Write risk is adjusted by zone inside the workspace; read-only commands are unaffected. Below you can add extra free directories and configure whether outside writes require confirmation.',
        zoneFree: 'Free zone (no confirmation)',
        zoneProtected: 'Protected zone (confirmation required)',
        zoneOutside: 'Outside workspace',
        zoneOutsideText: 'Safe writes outside the workspace are not upgraded by default; enable the toggle below to require moderate confirmation. System paths → blocked / dangerous (see tiers above).',
      ...
      userCommandRules: {
        ...
        description: 'Set a default risk for commands the app doesn’t know yet (e.g. fd, bat). Leave “Modifies files” unchecked for read-only tools. “Allowed options” is an optional allowlist—list common harmless options; they don’t all have to appear together. Any option not listed bumps risk to medium. Cannot override built-ins or set blocked.',
        cmdPlaceholder: 'Command name, e.g. fd',
        flagsPlaceholder: 'Allowed options, e.g. -H -I (optional)',
        flagsFieldLabel: 'Allowed options',
        writesLabel: 'Modifies files',
        writesTip: 'Check if the command may create, change, or delete files. When checked, writes to protected or outside-workspace paths raise risk. Leave unchecked for read-only tools (search, view).',
        flagsTip: 'This is an allowlist of options that may appear—not a set that must all be present. If you list -H -I, the command may use -H, -I, or both. Any option not listed here bumps risk to medium. Leaving this empty is fine—extra options will just bump the level sooner.',
        add: 'Add rule',
      ...
      userAllowlist: {
        ...
        description: 'Exact commands you marked Always Allow in the confirm dialog (skip confirm for that fingerprint—not for defining command risk). To rate new commands like rg or fd, use Command Rules → My Command Rules. You can also add an exact allow below.',
        empty: 'No entries',
        emptyHint: 'Entries appear when you choose "Always Allow" in a confirmation dialog, or add a command above.',
        noMatch: 'No matching entries',
        selectAll: 'Select All',
        loading: 'Loading…',
        confirmClear: 'Clear all entries? This cannot be undone.',
        toolName: 'Type',
        shellCommand: 'Command',
        keyArgs: 'Command',
        riskAtApproval: 'Risk at Approval',
        riskBlocked: 'Blocked',
        ...
        timeDaysAgo: '{n}d ago',
        add: 'Add',
        addPlaceholder: 'Full command to always allow, e.g. git status',
        addBlocked: 'This command is blocked and cannot be added.',
      ...
      riskPolicy: {
        ...
        strictDesc: 'All commands require confirmation; the level here sets display color and allowlist risk snapshots',
