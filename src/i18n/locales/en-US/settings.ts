...
export default {
  ...
  browserBridge: {
    ...
    setupDesc: 'Pick a browser and follow the steps below to load the extension. Connected browsers turn green in real time.',
    ...
    otherChromiumHint: 'Other Chromium browsers (Arc, Brave, Vivaldi, Opera…) load the same way as Chrome.',
    ...
    startLoadEdge: 'Use Edge instead',
    loadExtensionReadyMac: 'Chrome and Finder are open. Follow the green steps — drag the folder into Chrome.',
    loadExtensionReady: 'Path copied. Open Developer mode → Load unpacked → paste path.',
    howToLoadChromium: 'How to load the extension?',
    dragStep1: 'Click the button above — Chrome extensions and a Finder window will open',
    dragStep2: 'In Chrome: enable Developer mode → Load unpacked',
    dragStep3Prefix: 'In Finder, find the folder named',
    dragStep3Suffix: 'and drag it into Chrome\'s gray selection window',
    ...
    oneBrowserNote: 'Load the extension in one Chromium browser (Chrome, Edge, Arc, Brave, Vivaldi, Opera, etc.). Repair connection refreshes native messaging registration on this machine.',
    ...
    troubleshootStep1: 'Under Connection helper, click Repair connection, then fully quit Chrome (⌘Q) and reopen',
    troubleshootStep2Prefix: 'On chrome://extensions confirm extension ID is',
    ...
    troubleshootStep5: 'After reloading the extension, check ~/.sailfish-host.log for new lines (means Chrome launched the host; empty means host still not found)',
    openGuideFailed: {
