  ...
  settings: {
    ...
    security: {
      ...
      builtinRules: {
        ...
        zoneOutsideText: 'Outside workspace: write/delete → dangerous; falling into system paths → blocked',
        zoneSystemText: 'System critical directories (/etc, /dev, /System, C:\\Windows, etc.) write/delete → blocked',
        loading: 'Loading…',
      ...
      riskPolicy: {
        ...
        relaxedDesc: 'By default only dangerous/blocked require confirmation',
        ...
        outsideWritesUpgrade: 'Upgrade outside-workspace writes',
        outsideWritesUpgradeDesc: 'When on, safe commands (e.g. cp) writing outside the workspace become moderate.',
