...
export default {
  ...
  browserBridge: {
    ...
    firefoxTempNote: 'Temporary load is lost after Firefox restarts. For persistence you need a signed Mozilla XPI.',
    ...
    oneBrowserNote: 'Use one Chromium browser (Chrome, Arc, Brave, Edge, etc.). Reinstall registers all known browser directories on this machine.',
