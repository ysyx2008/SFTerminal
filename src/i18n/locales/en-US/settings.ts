  ...
  settings: {
    ...
    security: {
      ...
      builtinRules: {
        ...
        writesYes: 'Yes',
        writesNo: 'No',
        hardBlockedPaths: 'Hard-Blocked Paths',
        hardBlockedPathsDesc: 'Write/delete operations on the paths below are blocked outright and cannot be downgraded by workspace zones or user approval.',
        systemPatterns: 'System Critical Paths',
