...
export default {
  ...
  settings: {
    ...
    im: {
      ...
      wechatStep1: 'Click "Scan to Login" below to get a QR code',
      wechatStep2: 'Scan the QR code with WeChat and confirm authorization',
      wechatStep3: 'Once logged in, you can start chatting. Credentials are saved automatically',
      wechatLoginBtn: 'Scan to Login',
      wechatScanHint: 'Open the link in browser and scan the QR code with WeChat:',
  ...
  browserBridge: {
    ...
    installing: 'Installing…',
    installIntro: 'Install SailFish components once, then load the extension in Chrome or install from Firefox Add-ons (~1 min, one-time).',
    installSuccessShort: 'Components installed. Load the extension for each browser you need below.',
    ...
    oneBrowserNote: 'Load the extension in one Chromium browser (Chrome, Edge, Arc, Brave, Vivaldi, Opera, etc.). Reinstall refreshes native messaging registration on this machine.',
    reinstall: 'Reinstall components',
    reinstallSuccess: 'Components reinstalled.',
    uninstall: 'Uninstall components',
    uninstalling: 'Uninstalling…',
    uninstallSuccess: 'Components uninstalled. Remove the extension manually in your browser if it still appears.',
    confirmUninstall: 'Uninstall Browser Assistant components?\n\nThis removes local extension files and native host registration. You must remove the loaded extension in your browser manually.',
    ...
    troubleshootStep1: 'Under Advanced, click Reinstall, then fully quit Chrome (⌘Q) and reopen',
    ...
    troubleshootStep4: 'If you changed the data directory, reinstall components and restart the browser',
