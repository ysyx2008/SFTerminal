  ...
  settings: {
    ...
    security: {
      ...
      builtinRules: {
        ...
        argvCommandsDesc: 'Unlisted commands → dangerous; unknown flags → moderate. The safe tier only includes read-only commands.',
        ...
        workspaceZonesDesc: 'Write risk is adjusted by zone inside the workspace; read-only commands are unaffected.',
        zoneFree: 'Free zone (no confirmation)',
        zoneProtected: 'Protected zone (confirmation required)',
        zoneOutside: 'Outside workspace',
        zoneOutsideText: 'Safe writes outside the workspace are not upgraded by default; enable confirmation in Risk Policy. System paths → blocked / dangerous (see tiers above).',
      ...
      riskPolicy: {
        ...
        description: 'Default risk levels for parse-fail, unknown commands, indirection, and dynamic paths—per execution mode. Also configure confirm threshold, outside-write upgrade, sub-agent ceiling, and extra free directories.',
        ...
        extraFreeDirsDesc: 'These absolute paths are treated as free zones (read/write/delete without confirm), same as scratch/charts.',
