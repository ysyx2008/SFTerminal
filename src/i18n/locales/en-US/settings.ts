  ...
  settings: {
    ...
    security: {
      ...
      builtinRules: {
        ...
        description: 'Command baselines and system paths are read-only; use My Command Rules to cover unlisted commands. Workspace zones let you add free directories and configure outside-write confirmation.',
      ...
      userCommandRules: {
        ...
        description: 'Define risk for unlisted command names (e.g. rg, fd). Same evaluation as the built-in baseline; cannot override built-ins or set blocked.',
        cmdPlaceholder: 'Command name, e.g. rg',
        flagsPlaceholder: 'Safe flags, e.g. -n -i --color',
        writesLabel: 'Writes to disk',
        add: 'Add rule',
      ...
      userAllowlist: {
        ...
        description: 'Exact commands you marked Always Allow in the confirm dialog (skip confirm for that fingerprint—not for defining command risk). To rate new commands like rg or fd, use Built-in Rules → My Command Rules. You can also add an exact allow below.',
        empty: 'No entries',
