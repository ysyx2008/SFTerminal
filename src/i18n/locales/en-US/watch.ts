...
export default {
  ...
  watch: {
    ...
    overviewBack: 'Back',
    overviewViewMore: 'More',
    overviewClearFocus: 'Back',
    overviewRecentForWatch: '{name} · Recent',
    overviewNoHistoryForWatch: 'No runs for this watch yet',
    overviewHistoryForWatch: '{name} · History',
    overviewShowAllWatchesHistory: 'All watches',
