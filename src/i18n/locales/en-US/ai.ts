...
export default {
  ...
  ai: {
    ...
    waitingForModel: {
      diving: 'Diving…',
      scanning: 'Scanning…',
      waitingWave: 'Waiting for the wave…',
      booting: 'Booting up…',
      neurons: 'Neurons connecting…',
      inspiration: 'Loading inspiration…',
      calling: 'Calling the model…',
      easter: {
        coffee: 'Sailfish is having coffee…',
        bribingGpu: 'Bribing the GPU…',
        quantum: 'Quantum entangling…',
        yoda: 'Summoning Yoda…',
        haggling: 'Haggling with the model…',
      },
      slow: {
        slacking: 'The model might be slacking…',
        patience: 'Still waiting—patience is a virtue…',
        deepBreath: 'It\'s taking a deep breath…',
        novel: 'Maybe it\'s writing a novel…',
        almostThere: 'Almost there, really…',
      },
    },
    executing: 'Executing...',
