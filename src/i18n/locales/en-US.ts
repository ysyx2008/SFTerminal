export default {
  ...
  ai: {
    ...
    visionGuardDetail: 'Recommended: switch to a vision model (e.g. qwen-vl-plus, gpt-4o) in AI Settings, or link a vision model to the current profile and enable "Auto Vision Model".',
